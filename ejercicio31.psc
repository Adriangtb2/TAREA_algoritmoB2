//ejercicio7: ingresar "N" enteros, visualizar la suma de los numeros paes de la lista, cuantos numeros pares existen y cual es el promedio de los numeros impares.
